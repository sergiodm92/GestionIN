...
import { FormRequestService, RequestService } from "../../types/requestsInterfaces";
import { handleRequestServiceChange, handleToggleSwitch } from "../functions/newRequest/functions";
...
const FormRequestService = (data: FormRequestService) => {
  const {
    isOn,
    setIsOn,
    places,
  ...
  const productGroupHandleSubmit = async (e: any, product: Products, request: RequestService, setProduct: any, productSelectedUnits:number, setIsLoading: React.Dispatch<React.SetStateAction<boolean>>) => {
    e.preventDefault();
    setIsLoading(true)
    try {
