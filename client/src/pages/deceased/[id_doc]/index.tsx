        ...
        : (
          <div className={styles.card}>
            ...
            <div className={styles.items}>
              ...
              <div className={styles.text}>{updateData.tombstone=='pending'?"Pendiente": updateData.tombstone=='sent'?"Enviada":updateData.tombstone=='approved'?"Aprobada":"Despachadas"}</div>
            </div>
          </div>
        )}
    </div>
