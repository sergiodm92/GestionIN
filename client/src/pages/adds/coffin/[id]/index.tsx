        ...
        <div className={styles.card}>
          ...
          <div className={styles.items}>
            ...
            <div className={styles.text}>
              {new Date(add.date).toLocaleDateString("es")}
            </div>
          </div>
          <div className={styles.items}>
          ...
          <div className={styles.items}>
            ...
            <div className={styles.text}>
              {add.status === "pending" ? "Pendiente" : "Completo"}
            </div>
          </div>
          {add.coffins && add.coffins.length ? (
                ...
                {add.coffins.map((c, i) => {
                  return (
                    <div key={i}>
                      ...
                      <div>
                        Con caja metálica: {c.mbox === true ? "Si" : "No"}
                      </div>
          ...
          {add.metal_box && add.metal_box.length ? (
            <div className={styles.itemsGroups}>
