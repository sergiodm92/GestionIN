...
from models import Coffin, Transfer
from middlewares.response import custom_response_success, custom_response_error
from middlewares.verify_token import verify_token
from services.coffin_stock_services import (get_coffin_stock, post_model, get_coffin_stock_place, get_coffin_stock_id_service, post_transfer)
